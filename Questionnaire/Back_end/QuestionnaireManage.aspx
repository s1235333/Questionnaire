...
<body>
    ...
    <form id="form1" runat="server">
            ...
            <tr>
                <td>
                    <asp:PlaceHolder ID="plcEdit" runat="server">
                        <a href="/Back_end/QuestionnaireList.aspx">問卷管理</a><br />
                        <a href="/Back_end/Oftenused.aspx">常用問題管理</a><br />
                    </asp:PlaceHolder>
                </td>
                <td>
                    <nav>
                        <div class="nav nav-tabs" id="nav-tab" role="tablist">
                            <button class="nav-link active" id="nav-questionnaire-tab" data-bs-toggle="tab" data-bs-target="#nav-questionnaire" type="button" role="tab" aria-controls="nav-questionnaire" aria-selected="true">問卷</button>
                            <button class="nav-link" id="nav-question-tab" data-bs-toggle="tab" data-bs-target="#nav-question" type="button" role="tab" aria-controls="nav-question" aria-selected="false">問題</button>
                            <button class="nav-link" id="nav-info-tab" data-bs-toggle="tab" data-bs-target="#nav-info" type="button" role="tab" aria-controls="nav-info" aria-selected="false">填寫資料</button>
                        </div>
                    </nav>
      ...
      <asp:Button ID="Nextstep_btn1" runat="server" Text="下一步" OnClick="Nextstep_btn1_Click" />
                        ...
                        <div class="tab-pane fade" id="nav-question" role="tabpanel" aria-labelledby="nav-question">
                            種類: 
